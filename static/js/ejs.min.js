  ...
  }()(
      {
        1: [
          function(require, module, exports) {
            ...
            exports.resolveInclude = function(name, filename, isDir) {
              ...
              var includePath =
                  resolve(isDir ? filename : dirname(filename), name);
            ...
            function getIncludePath(path, options) {
              ...
              if (path.charAt(0) == "/") {
                includePath = exports.resolveInclude(path.replace(/^\/*/, ""),
                                                     options.root || "/", true)
              } else {
                if (options.filename) {
            ...
            function includeSource(path, options) {
              ...
              return {
                source: templ.source, filename: includePath, template: template
              }
            }
            ...
            Template.prototype = {
              ...
              compile: function() {
                ...
                if (opts.compileDebug) {
                  src = "var __line = 1" + "\n" + "  , __lines = " +
                        ...
                        "  , __filename = " +
                        (opts.filename ? JSON.stringify(opts.filename) :
                                         "undefined") +
                        ";" + "\n" + "try {" + "\n" + this.source +
                        "} catch (e) {" + "\n" +
              ...
              generateSource: function() {
                ...
                if (opts.rmWhitespace) {
                  this.templateText = this.templateText.replace(/\r/g, "")
                                          .replace(/^\s+|\s+$/gm, "")
                }
                this.templateText =
                    this.templateText.replace(/[ \t]*<%_/gm, "<%_")
                        .replace(/_%>[ \t]*/gm, "_%>");
                var self = this;
            ...
            if (require.extensions) {
              require.extensions[".ejs"] = function(module, flnm) {
                ...
                module._compile("module.exports = " + fn.toString() + ";",
                                filename)
              }
            }
        ...
        2: [
          function(require, module, exports) {
            ...
            exports.escapeXML = function(markup) {
              return markup == undefined ? "" : String(markup).replace(
                                                    _MATCH_HTML, encode_char)
            };
        ...
        5: [
          function(require, module, exports) {
            ...
            function defaultClearTimeout(){throw new Error(
                "clearTimeout has not been defined")}(function() {
              try {
        ...
        6: [
          function(require, module, exports) {
            module.exports = {
              ...
              devDependencies: {
                browserify: "^13.1.1",
                eslint: "^4.14.0", "git-directory-deploy": "^1.5.1",
                istanbul: "~0.4.3",
                jake: "^8.0.16",
                jsdoc: "^3.4.0", "lru-cache": "^4.0.1",
                mocha: "^5.0.5", "uglify-js": "^3.3.16"
              },
              engines: {node: ">=0.10.0"},
              scripts: {
                test: "jake test",
